...
export class FixSaleOrderRelation1769521585841 implements MigrationInterface {
    name = 'FixSaleOrderRelation1769521585841'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "outbound" ("id_outbound" uuid NOT NULL DEFAULT uuid_generate_v4(), "outbound_number" character varying NOT NULL, "id_so" uuid NOT NULL, "id_user" uuid NOT NULL, "id_customer" uuid NOT NULL, "shipped_at" TIMESTAMP NOT NULL, "carrier_name" character varying NOT NULL, "tracking_number" character varying NOT NULL, "total_items" integer NOT NULL, "status_outbound" "public"."outbound_status_outbound_enum" NOT NULL DEFAULT 'OPEN', "note" character varying, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_33be109921055f53d126502493c" UNIQUE ("outbound_number"), CONSTRAINT "PK_6de34e699fe8365906a46c5600e" PRIMARY KEY ("id_outbound"))`);
        ...
        await queryRunner.query(`CREATE TABLE "sales_orders" ("id_so" uuid NOT NULL DEFAULT uuid_generate_v4(), "so_number" character varying NOT NULL, "so_status" "public"."sales_orders_so_status_enum" NOT NULL DEFAULT 'PENDING', "date_so" TIMESTAMP NOT NULL, "id_customer" uuid NOT NULL, "total_amount" integer NOT NULL, "status" character varying NOT NULL, "note" character varying NOT NULL, "id_user" uuid NOT NULL, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_11d4347629a3126af8cca9787d3" UNIQUE ("so_number"), CONSTRAINT "PK_20959038dd0b4ae7395baa11b76" PRIMARY KEY ("id_so"))`);
        await queryRunner.query(`CREATE TABLE "sale_order_items" ("id_soi" uuid NOT NULL DEFAULT uuid_generate_v4(), "id_so" uuid NOT NULL, "id_item" uuid NOT NULL, "qty_ordered" integer NOT NULL, "price_at_order" numeric(10,2) NOT NULL, "last_updated" TIMESTAMP NOT NULL DEFAULT now(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e79cc732b4b7a0071c1b3a8e91a" PRIMARY KEY ("id_soi"))`);
